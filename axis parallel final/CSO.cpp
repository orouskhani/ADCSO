...
int main(int argc, char* argv[])
{
  ...
  double d_InitL[i_FuncNum]={-5.12, -5.12, 0};       // Defines the left border of the initial ranges.
  double d_InitR[i_FuncNum]={5.12, 5.12, d_PIE};       // Defines the right border of the initial ranges.
